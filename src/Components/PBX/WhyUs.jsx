        ...
        <Grid item xs={12} sm={12} md={6} lg={6}>
          <Box sx={ContentSx}>
            ...
            <Typography variant="h3">
              Benefits of an IP PBX Solution from InsightTech
            </Typography>
            <Typography variant="body1" color="text.secondary">
              InsightTech&lsquo;s Trusted PBX Solutions Deliver Precision,
              Innovation, and Seamless Integration, Empowering Clients with
