        ...
        <Container sx={ContainerSx}>
            <Box sx={MainBox}>
                <Box sx={ContentContainerSx}>
                    ...
                    <Typography variant="h5" color="text.secondary" sx={{ textAlign: "center" }}> Elevating Your Online Presence Through Strategic Planning, Targeted Campaigns, and Data-Driven Insights</Typography>
                </Box>
                <ServiceCard />
            </Box >
        </Container >
