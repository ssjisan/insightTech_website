        ...
        <Container sx={ContainerSx}>
            <Box sx={MainBox}>
                <Box sx={ContentContainerSx}>
                    ...
                    <Typography variant="h5" color="text.secondary" sx={{ textAlign: "center" }}>Explore a comprehensive range of network services, from design to security, ensuring seamless connectivity and performance.</Typography>
                </Box>
                <ServiceCard />
            </Box >
        </Container >
